  ...
  return <>
      ...
      <section id="home" className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen pt-16 min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <iframe title="vimeo-player" src="https://player.vimeo.com/video/1129536015?h=180320caca&autoplay=1&loop=1&muted=1&controls=0&background=1" className="w-full h-full object-cover" frameBorder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" allowFullScreen />
        ...
        <div className="relative z-10 w-full px-6 lg:px-8 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 style={{
              filter: 'blur(0.6px)'
            }} className="text-4xl md:text-6xl font-serif text-black/90 leading-tight font-extrabold lg:text-6xl">
                BE THE FIRST WOMAN IN <span className="text-primary">YOUR FAMILY TO BUILD GENERATIONAL WEALTH—</span>START WITH YOUR PROPERTY CODE.
              </h1>
            ...
            <div className="inline-block mx-auto">
              <div className="bg-background/80 backdrop-blur-md px-8 py-4 rounded-full border border-accent/30 shadow-soft">
                ...
                <div className="flex items-center gap-1 justify-center">
                  {[...Array(5)].map((_, i) => <svg key={i} className="w-5 h-5 text-primary fill-current" viewBox="0 0 20 20">
