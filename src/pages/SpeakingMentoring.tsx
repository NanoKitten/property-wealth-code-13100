        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="space-y-12">
            <div className="relative overflow-hidden rounded-3xl h-[600px]">
              <img src={workshopEvent} alt="Interactive workshops" className="w-full h-full object-cover" />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="relative h-96 rounded-2xl overflow-hidden group">
                <img src={keynoteSpeaking} alt="Keynote speaking" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-8">
                  <div className="text-white space-y-2">
